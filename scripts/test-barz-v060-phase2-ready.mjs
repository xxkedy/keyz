...
const checks=[
  ...
  ['GO countdown screen',/id="goScreen"[\s\S]*id="goCount">3</],
  ['one-screen RAP shell',/class="rapScreen" id="rapScreen"/],
  ['visible 16:9 player slot',/class="rapPlayer" id="rapPlayer"/],
  ['compact REC take status',/●<\/span> REC [\s\S]*id="rapTake"/],
  ['large KEEP control',/class="rapKeep" id="rapKeep"[^>]*>⭐ KEEP</],
  ['RAP action order',/id="rapRetake"[^>]*>RETAKE[\s\S]*id="rapNext"[^>]*>NEXT[\s\S]*id="rapEnd"[^>]*>END/],
  ['session mic reuse',/async function ensureMic\(\)[\s\S]*readyState==='live'/],
  ['long-press destructive controls',/bindHold\(rapRetake,'retake'\);bindHold\(rapEnd,'end'\)/],
