const CACHE='appz-v9.7-polish-20260903';
const LOCAL=['./','./index.html','./manifest.json?v=20260903-4','./icon-180.png?v=20260729-1','./icon-192.png?v=20260729-1','./icon-512.png?v=20260729-1'];
